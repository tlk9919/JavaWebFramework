...
public class StudentController3 {
    ...
    public static void main(String[] args) {
        ...
        studentService1.setStudentDao(studentDao);

        //创建controller对象
        StudentController3 studentController3=new StudentController3();
        studentController3.setStudentService(studentService1);



        // 模拟前端请求，调用 Controller 方法处理
        String res=studentController3.addStudent(student);
